...
namespace CaptainHook.DirectorService.Infrastructure
{
    public class ReaderServiceNameGenerator: IReaderServiceNameGenerator
    {
        ...
        public string GenerateNewName(SubscriberConfiguration subscriber)
        {
        ...
        public IList<string> FindOldNames(SubscriberConfiguration subscriber, IList<string> serviceList)
        {
            var readerServiceNameUri = ServiceNaming.EventReaderServiceFullUri(subscriber.EventType, subscriber.SubscriberName, subscriber.DLQMode != null);
