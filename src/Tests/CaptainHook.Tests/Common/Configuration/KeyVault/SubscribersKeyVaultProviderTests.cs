    ...
    public class SubscribersKeyVaultProviderTests
    {
        ...
        public void Load_WhenItemInArrayIsMissing_ReturnError()
        {
            var configurationData = @"{""event"":{
                ...
                ""1:callbackconfig:webhookrequestrules:1:routes:3:authenticationconfig:scopes:1"": ""scope1"",
                ""1:callbackconfig:webhookrequestrules:1:routes:3:authenticationconfig:scopes:2"": ""scope2"",
                ...
                .WithCallback(callback => callback
                    ...
                    .AddWebhookRequestRule(rule => rule
                        ...
                        .AddRoute(route => route
                            ...
                            .WithSelector("testsel2")
                            .WithHttpVerb("POST")
                            .WithOidcAuthentication())
                        .AddRoute(route => route
                            .WithUri("https://callback.eshopworld.com/route3")
                            .WithSelector("testsel3")
                            .WithHttpVerb("POST")
                            .WithOidcAuthentication())
                ))
                .AsMainConfiguration()
