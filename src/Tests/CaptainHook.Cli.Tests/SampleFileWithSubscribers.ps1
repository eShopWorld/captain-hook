...
setConfig 'event--1--callbackconfig--authenticationconfig--type' 'None' $KeyVault
setConfig 'event--1--callbackconfig--httpverb' 'POST' $KeyVault
...
#event 10
setConfig 'event--3--name' 'activity1.domain.randomevent-name' $KeyVault
setConfig 'event--3--type' 'activity1.domain.randomevent-type' $KeyVault

setConfig 'event--3--webhookconfig--name' 'activity1.domain.randomevents-webhook' $KeyVault
setConfig 'event--3--webhookconfig--uri' 'https://activity1-api.com/api/v2/webhook/' $KeyVault
setConfig 'event--3--webhookconfig--authenticationconfig--type' 'OIDC' $KeyVault
setConfig 'event--3--webhookconfig--authenticationconfig--uri' 'https://security.test.company.com/connect/token' $KeyVault
setConfig 'event--3--webhookconfig--authenticationconfig--clientid' 'clientid.test.client' $KeyVault
setConfig 'event--3--webhookconfig--authenticationconfig--clientsecret' 'verylongandsecuresecret' $KeyVault
setConfig 'event--3--webhookconfig--authenticationconfig--scopes' 'webhook.api.all' $KeyVault
setConfig 'event--3--webhookconfig--httpverb' 'post' $KeyVault
# subscriber1
setConfig 'event--3--subscribers--1--name' 'subscriber1.activity1.domain.randomevents-webhook' $KeyVault
setConfig 'event--3--subscribers--1--subscribername' 'event.subscribername-1' $KeyVault
setConfig 'event--3--subscribers--1--uri' 'https://subscriber1-api.com/api/v2/webhook/' $KeyVault
setConfig 'event--3--subscribers--1--authenticationconfig--type' 'OIDC' $KeyVault
setConfig 'event--3--subscribers--1--authenticationconfig--uri' 'https://security.test.company.com/connect/token' $KeyVault
setConfig 'event--3--subscribers--1--authenticationconfig--clientid' 'clientid.test.client' $KeyVault
setConfig 'event--3--subscribers--1--authenticationconfig--clientsecret' 'verylongandsecuresecret' $KeyVault
setConfig 'event--3--subscribers--1--authenticationconfig--scopes' 'webhook.api.all' $KeyVault
setConfig 'event--3--subscribers--1--httpverb' 'post' $KeyVault
#subscriber2
setConfig 'event--3--subscribers--2--name' 'subscriber2.activity1.domain.randomevents-webhook' $KeyVault
setConfig 'event--3--subscribers--2--subscribername' 'event.subscribername-2' $KeyVault
setConfig 'event--3--subscribers--2--uri' 'https://subscriber2-api.com/api/v2/webhook/' $KeyVault
setConfig 'event--3--subscribers--2--authenticationconfig--type' 'OIDC' $KeyVault
setConfig 'event--3--subscribers--2--authenticationconfig--uri' 'https://security.test.company.com/connect/token' $KeyVault
setConfig 'event--3--subscribers--2--authenticationconfig--clientid' 'clientid.test.client' $KeyVault
setConfig 'event--3--subscribers--2--authenticationconfig--clientsecret' 'verylongandsecuresecret' $KeyVault
setConfig 'event--3--subscribers--2--authenticationconfig--scopes' 'webhook.api.all' $KeyVault
setConfig 'event--3--subscribers--2--httpverb' 'post' $KeyVault
#subscriber3
setConfig 'event--3--subscribers--3--name' 'subscriber3.activity1.domain.randomevents-webhook' $KeyVault
setConfig 'event--3--subscribers--3--subscribername' 'event.subscribername-3' $KeyVault
setConfig 'event--3--subscribers--3--uri' 'https://subscriber3-api.com/api/v2/webhook/' $KeyVault
setConfig 'event--3--subscribers--3--authenticationconfig--type' 'OIDC' $KeyVault
setConfig 'event--3--subscribers--3--authenticationconfig--uri' 'https://security.test.company.com/connect/token' $KeyVault
setConfig 'event--3--subscribers--3--authenticationconfig--clientid' 'clientid.test.client' $KeyVault
setConfig 'event--3--subscribers--3--authenticationconfig--clientsecret' 'verylongandsecuresecret' $KeyVault
setConfig 'event--3--subscribers--3--authenticationconfig--scopes' 'webhook.api.all' $KeyVault
setConfig 'event--3--subscribers--3--httpverb' 'post' $KeyVault
#subscriber4
setConfig 'event--3--subscribers--4--name' 'subscriber4.activity1.domain.randomevents-webhook' $KeyVault
setConfig 'event--3--subscribers--4--subscribername' 'event.subscribername-4' $KeyVault
setConfig 'event--3--subscribers--4--uri' 'https://subscriber4-api.com/api/v2/webhook/' $KeyVault
setConfig 'event--3--subscribers--4--authenticationconfig--type' 'OIDC' $KeyVault
setConfig 'event--3--subscribers--4--authenticationconfig--uri' 'https://security.test.company.com/connect/token' $KeyVault
setConfig 'event--3--subscribers--4--authenticationconfig--clientid' 'clientid.test.client' $KeyVault
setConfig 'event--3--subscribers--4--authenticationconfig--clientsecret' 'verylongandsecuresecret' $KeyVault
setConfig 'event--3--subscribers--4--authenticationconfig--scopes' 'webhook.api.all' $KeyVault
setConfig 'event--3--subscribers--4--httpverb' 'post' $KeyVault
